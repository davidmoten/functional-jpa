...
class TypedQueryIterator<T> extends AbstractIterator<T> {
    ...
    protected T computeNext() {
        ...
        if (!it.isPresent() || !it.get().hasNext()) {
            it = of(query.setFirstResult(position).setMaxResults(pageSize).getResultList()
                    .iterator());
            if (!it.get().hasNext())
                return endOfData();
        }
    ...
    public static class Builder<T> implements Iterable<T> {
        ...
        public Builder<T> parameter(Parameter<Calendar> arg0, Calendar arg1, TemporalType arg2) {
            query.setParameter(arg0, arg1, arg2);
            return this;
        }

        public Builder<T> parameter(Parameter<Date> arg0, Date arg1, TemporalType arg2) {
            query.setParameter(arg0, arg1);
            return this;
        }

        public Builder<T> parameter(String arg0, Calendar arg1, TemporalType arg2) {
            query.setParameter(arg0, arg1, arg2);
            return this;
        }
